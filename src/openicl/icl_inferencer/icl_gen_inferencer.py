...
from src.openicl.icl_inferencer.icl_base_inferencer import IclBaseInferencer
from src.openicl.utils.api_service import * 
from typing import List, Union, Optional, Callable
from tqdm import tqdm
from torch.utils.data import DataLoader
from transformers import PretrainedConfig
from src.openicl.utils.collators import DataCollatorWithPaddingAndCuda
from src.openicl.icl_dataset_reader import DatasetEncoder
...
class IclGenInferencer(IclBaseInferencer):
    ...
    def __init__(self, 
                 ...
                 output_json_filename: Optional[str] = "icl_inference_output",
