...
from src.openicl.utils.api_service import *

from src.openicl.icl_evaluator.icl_base_evaluator import IclBaseEvaluator
from src.openicl.icl_evaluator.icl_acc_evaluator import IclAccEvaluator
from src.openicl.icl_evaluator.icl_bleu_evaluator import IclBleuEvaluator
from src.openicl.icl_evaluator.icl_squad_evaluator import IclSquadEvaluator

from transformers import AutoTokenizer, AutoModelForCausalLM, PretrainedConfig, GPT2Tokenizer, AutoModelForSeq2SeqLM, AutoModel
...
class IclBaseInferencer:
    ...
    def score(self, src_lang=None, tgt_lang=None,output_dir=None):

        print(src_lang,tgt_lang)
        predictions = self.inference(src_lang, tgt_lang)
        if self.accelerator is None:
            return self.metric.score(predictions, src_lang=src_lang, tgt_lang=tgt_lang,output_dir=output_dir)
